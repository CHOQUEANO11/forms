            ...
            <Page size="A4" style={styles.Page} >
                <View style={styles.body}>
                    ...
                    <View style={styles.title}>
                        <Text>FICHA DE AVALIAÇÃO DE POTENCIAL E EXPERIÊNCIA PROFISSIONAL DE OFICIAL</Text>
                    </View>
                    <View style={styles.form} >
                        <Text style={styles.titleForm}> NOME: </Text>
                        <Text style={styles.titleForm}>POSTO: </Text>
                        <Text style={styles.titleForm}>QUALIFICAÇÃO:  {props.referencia}</Text>
                        <Text style={styles.titleForm}>PERÍODO NO POSTO: </Text>
                        <Text style={styles.title}>PONTUAÇÕES POSITIVAS </Text>
                        <Text style={styles.title}>1 - EXPERIÊNCIA PROFISSIONAL NO POSTO ATUAL </Text>
                        ...
                        NO POSTO ATUAL </Text>
                        <Text style={styles.titleForm}>2.1 - Obras literáriase manuais profissionais:  </Text>
                        <Text style={styles.titleForm}>2.2 - Habilitação para o exercício da docência PM-30h/a (Por ano) </Text>
                        ...
                        <Text style={styles.titleForm}>3.1.1 - CAO (Promoção a MAJ e TEN CEL): </Text>
                        <Text style={styles.titleForm}>3.1.2 - CSP (Promoção a CEL):  </Text>
                        <Text style={styles.titleForm}>3.1.3 - Pós-Doutorado:  </Text>
                        <Text style={styles.titleForm}>3.1.4 - Doutorado:  </Text>
                        <Text style={styles.titleForm}>3.1.5 - Pós-Graduação:  </Text>
